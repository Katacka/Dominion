...
import project.katacka.dominion.gameframework.actionMsg.ReadyAction;
import project.katacka.dominion.gameframework.infoMsg.BindGameInfo;
import project.katacka.dominion.gameframework.infoMsg.GameInfo;
import project.katacka.dominion.gameframework.infoMsg.GameOverInfo;
import project.katacka.dominion.gameframework.infoMsg.StartGameInfo;
import project.katacka.dominion.gameframework.infoMsg.TimerInfo;
import project.katacka.dominion.gameframework.util.GameTimer;
import project.katacka.dominion.gameframework.util.MessageBox;
import project.katacka.dominion.gameframework.util.Tickable;
 ...
 * @version July 2013
 */
public abstract class GameComputerPlayer implements project.katacka.dominion.gameframework.GamePlayer, Tickable {
	/**
	 * the current game state
	 */
	protected project.katacka.dominion.gameframework.Game game; // the game object
	...
	private project.katacka.dominion.gameframework.GameMainActivity myActivity; // the game's main activity, set only
